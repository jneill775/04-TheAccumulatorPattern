...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 4
    answer = count_cosines_from(4, 15, 0.33)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 0
    answer = count_cosines_from(1, 4, 0.6)
    ...
    # Test 5:
    expected = 4
    answer = count_cosines_from(1, 7, -0.3)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(7, 10, 0.14)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.884524  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(4, 8)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected =  1.019877  # This is APPROXIMATELY the correct answer.
